...
def load_data(fpath='/var/tmp/fashion.npz'):
...
def _mkdata(fpath):
    _download('/var/tmp/fashion_X_train.gz',
              'http://fashion-mnist.s3-website.eu-central-1.amazonaws.com/'
              'train-images-idx3-ubyte.gz')
    _download('/var/tmp/fashion_y_train.gz',
              'http://fashion-mnist.s3-website.eu-central-1.amazonaws.com/'
              'train-labels-idx1-ubyte.gz')
    _download('/var/tmp/fashion_X_test.gz',
              'http://fashion-mnist.s3-website.eu-central-1.amazonaws.com/'
              't10k-images-idx3-ubyte.gz')
    _download('/var/tmp/fashion_y_test.gz',
              'http://fashion-mnist.s3-website.eu-central-1.amazonaws.com/'
              't10k-labels-idx1-ubyte.gz')

    X_train = _extract_images('/var/tmp/fashion_X_train.gz')
    y_train = _extract_labels('/var/tmp/fashion_y_train.gz')
    y_train = np.expand_dims(y_train, 1)
    X_test = _extract_images('/var/tmp/fashion_X_test.gz')
    y_test = _extract_labels('/var/tmp/fashion_y_test.gz')
